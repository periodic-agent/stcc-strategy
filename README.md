...
| `data/` | Operation vocabulary, strip palette, strategy index |
| `tools/` | Strategy-index rebuild used by the GitHub Action |

Card data and site are maintained by Periodic_agent.
