...
.vt .ctag{{writing-mode:vertical-rl;text-orientation:mixed;display:flex;align-items:center;justify-content:center;padding:.9rem .14rem .55rem;line-height:1.1;font-family:'Antonio',sans-serif;font-size:.66rem;font-weight:600;letter-spacing:.05em;border-radius:0 0 4px 4px;margin-top:-4px;border:none}}
